...
- Characters are sorted by trust descending; the task scrolls through the full list automatically
- Only characters with trust rewards unlocked are collected
  :::
