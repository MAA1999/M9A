...
| :---: | :---: | :---: | :---: | :---: |
| 系统要求 | x86-64 架构、 Windows10 及以上 | 自行尝试 | 自行尝试 | 不受支持 |
| 需要配置环境 | 是 | 是 | 是 | 是 |
| 需要模拟器 | 是 | 是 | 模拟器或容器化安卓 | / |
...
<table style="border-collapse: collapse; width: 100%;">
    <thead>
        <tr>
            <th style="border: 1px solid #ddd; padding: 8px; text-align: center; background-color: #f2f2f2;" rowspan="2">启动方式</th>
            <th style="border: 1px solid #ddd; padding: 8px; text-align: center; background-color: #f2f2f2;" colspan="2">Windows</th>
            <th style="border: 1px solid #ddd; padding: 8px; text-align: center; background-color: #f2f2f2;" colspan="2">macOS</th>
            <th style="border: 1px solid #ddd; padding: 8px; text-align: center; background-color: #f2f2f2;" colspan="2">Linux</th>
        </tr>
        <tr>
            <th style="border: 1px solid #ddd; padding: 8px; text-align: center; background-color: #f2f2f2;">命令行（MaaPiCli）</th>
            <th style="border: 1px solid #ddd; padding: 8px; text-align: center; background-color: #f2f2f2;">图形界面（MFAAvalonia）</th>
            <th style="border: 1px solid #ddd; padding: 8px; text-align: center; background-color: #f2f2f2;">命令行</th>
            <th style="border: 1px solid #ddd; padding: 8px; text-align: center; background-color: #f2f2f2;">图形界面</th>
            <th style="border: 1px solid #ddd; padding: 8px; text-align: center; background-color: #f2f2f2;">命令行</th>
            <th style="border: 1px solid #ddd; padding: 8px; text-align: center; background-color: #f2f2f2;">图形界面</th>
        </tr>
    </thead>
    <tbody>
        <tr>
            <td style="border: 1px solid #ddd; padding: 8px; text-align: center;">需要安装VCRedist</td>
            <td style="border: 1px solid #ddd; padding: 8px; text-align: center;" colspan="2">是（<a href="#">链接</a>）</td>
            <td style="border: 1px solid #ddd; padding: 8px; text-align: center;" colspan="4">否</td>
        </tr>
        <tr>
            <td style="border: 1px solid #ddd; padding: 8px; text-align: center;">需要安装.NET 8</td>
            <td style="border: 1px solid #ddd; padding: 8px; text-align: center;">否</td>
            <td style="border: 1px solid #ddd; padding: 8px; text-align: center;">是（<a href="#">链接</a>）</td>
            <td style="border: 1px solid #ddd; padding: 8px; text-align: center;">否</td>
            <td style="border: 1px solid #ddd; padding: 8px; text-align: center;">是</td>
            <td style="border: 1px solid #ddd; padding: 8px; text-align: center;">否</td>
            <td style="border: 1px solid #ddd; padding: 8px; text-align: center;">是</td>
        </tr>
        <tr>
            <td style="border: 1px solid #ddd; padding: 8px; text-align: center;">需要安装python</td>
            <td style="border: 1px solid #ddd; padding: 8px; text-align: center;" colspan="4">压缩包自带，无需其他操作</td>
            <td style="border: 1px solid #ddd; padding: 8px; text-align: center;" colspan="2">3.1.0≤python＜3.14</td>
        </tr>
    </tbody>
</table>
