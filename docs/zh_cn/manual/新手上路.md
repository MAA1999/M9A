...
<table>
    ...
    <tbody>
        ...
        <tr>
            <td><div align="center">安装方式</div></td>
            <td colspan="6"><div align="center">点击（<a href="https://aka.ms/vs/17/release/vc_redist.x64.exe" target="_blank">链接</a>）下载或通过 winget 安装（详见下方）</div></td>
        </tr>
        <tr>
