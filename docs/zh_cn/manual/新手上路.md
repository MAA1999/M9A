...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td colspan="2"><div align="center">是</div></td>
        ...
        <tr>
            <td><div align="center">安装方式</div></td>
            <td colspan="6"><div align="center">前往（<a href="https://dotnet.microsoft.com/zh-cn/download/dotnet/8.0" target="_blank">链接</a>）下载对应版本或通过 winget 安装（详见下方）</div></td>
        </tr>
        <tr>
