...
| Android 用户 | M9A 提供 Android 客户端安装包（见 [Releases](https://github.com/MAA1999/M9A/releases)，真机推荐 `M9A-<版本>-arm64-v8a.apk`，模拟器等 x86 环境用 `M9A-<版本>-x86_64.apk`）<br>需要 Android 9 及以上；首次启动请授予通知与电池白名单，并选择 Shizuku 或 root 授权<br>也可前往 [MaaFramework](https://github.com/MaaXYZ/MaaFramework/) 自行安装通用客户端，参考 [使用方法](https://github.com/MaaXYZ/MaaFramework/issues/475) 与 [MAA文档](https://maa.plus/docs/zh-cn/manual/device/android.html) |
