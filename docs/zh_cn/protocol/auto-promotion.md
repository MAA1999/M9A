...
导航链（踩点于 2026-06，坐标 720p）：游戏主页 →「入场」按钮（约 [1105,288,67,41]）→
世纪末尺度页 → 底部菜单「映像」（[206,665,58,24]）→ 映像页（标志横幅
「领取全部每周活跃奖励后，可获得显影罐」）。卡片横排可左右滑动，每屏 3 张，
卡片标题在 y≈189-218，卡片可点击区 y≈230-460。点卡片 → 详情页 →
「活动正篇」（活动卡）/「主线正篇」（主线卡）→ 关卡地图页。
